            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        <a href="#" class="dropdown-item">회사소개</a>
                        <a href="#" class="dropdown-item">팀원소개</a>
                        <a href="#" class="dropdown-item">유관기관</a>
                        <a href="#" class="dropdown-item">기업 후원 안내</a>
                    </div>
                </div>
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        ...
                        <a href="#" class="dropdown-item">sns 챌린지</a>
                        <a href="#" class="dropdown-item">콜라보 챌린지</a>
                        <a href="#" class="dropdown-item">유저 챌린지</a>
                    </div>
                </div>
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        ...
                        <a href="#" class="dropdown-item">펀딩</a>
                    </div>
                </div>
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        ...
                        <a href="#" class="dropdown-item">에코 지도</a>
                        <a href="#" class="dropdown-item">에코 뉴스</a>
                    </div>
                </div>
            </div>
